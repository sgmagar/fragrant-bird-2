"""
Django settings for fragrant_bird_2 project.
...
ROOT_URLCONF = 'fragrant_bird_2.urls'
...
WSGI_APPLICATION = 'fragrant_bird_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fragrant_bird_2 API",
    "DESCRIPTION": "API documentation for fragrant_bird_2 App",
    "VERSION": "v1",
}
